// Set to true to use an internal configuration.
export const INTERNAL_CONFIG = false;

// const config = INTERNAL_CONFIG ? configure() : false;
        ...
        methods: {
          getAll: {
            ...
            dataTransform: ( item: any ) =>
              Object.assign(item, {
                wiki: `https://en.wikipedia.org/wiki/${item.name}`,
              }),
          },
          getSingle: {
            url: "/dead/:id",
